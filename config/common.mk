...
PRODUCT_COPY_FILES += \
    ...
    vendor/aosp/config/permissions/privapp-permissions-applock.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-applock.xml
...
PRODUCT_COPY_FILES += \
    ...
    vendor/aosp/prebuilt/common/etc/init/smartcharge-init.rc:$(TARGET_COPY_OUT_SYSTEM)/etc/init/smartcharge-init.rc
